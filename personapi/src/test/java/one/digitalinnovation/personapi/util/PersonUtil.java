...
public class PersonUtil {
    ...
    private static final String LAST_NAME = "Pachêco";
    private static final String CPF_NUMBER = "261.534.430-79";
    private static final long PERSON_ID = 1L;
    public static final LocalDate BIRTH_DATE = LocalDate.of(1986, 8, 8);
